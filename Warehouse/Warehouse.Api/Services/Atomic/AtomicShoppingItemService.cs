namespace Warehouse.Api.Services.Atomic
{
    ...
    internal class AtomicShoppingItemService : IAtomicShoppingItemService
    {
        ...
        /// <param name="transactionHandle">The database transaction handle.</param>
        /// <returns>A <see cref="Task" /> whose result indicates success.</returns>
        public Task DeleteByStockItemIdAsync(
            string userId,
            string stockItemId,
            CancellationToken cancellationToken,
            ITransactionHandle transactionHandle
        )
        {
            ...
            return this.provider.DeleteByStockItemIdAsync(
                userId,
                stockItemId,
                cancellationToken,
                transactionHandle);
        ...
        )
        {
            ...
            await this.provider.UpdateQuantityAsync(
                userId,
                shoppingItemId,
                quantityDelta,
                cancellationToken,
        ...
        /// <param name="transactionHandle">The database transaction handle.</param>
        /// <returns>A <see cref="Task" /> whose result indicates success.</returns>
        public Task UpdateQuantityByStockItemIdAsync(
            string userId,
            string stockItemId,
            int quantity,
            CancellationToken cancellationToken,
